<?php
/**
 * پستیار - اسکریپت عیب‌یابی و تشخیص هوشمند مشکلات سرور (Diagnostics)
 *
 * @package WHCM_SaaS
 */

// فعال‌سازی نمایش خطاها فقط در محیط development
$app_env = 'production';
...
echo '<h1 style="color: #6366f1; border-bottom: 1px solid rgba(255,255,255,0.1); padding-bottom: 0.75rem;">🔍 ابزار عیب‌یابی و تشخیصی پستیار</h1>';

echo '<p style="margin-top: 1rem;"><strong>نسخه پی‌اچ‌پی سرور شما:</strong> ' . phpversion() . '</p>';
...
try {
    ...
    echo '<p style="color: #10b981; font-weight: bold; margin-top: 1rem;">✔ هسته پستیار با موفقیت بارگذاری و اجرا شد و خطایی وجود ندارد!</p>';
    echo '<p>برای ورود به پستیار، روی لینک زیر کلیک کنید:</p>';
    echo '<p><a href="/" style="color: #6366f1; font-weight: bold; text-decoration: none;">🏠 ورود به صفحه اصلی پستیار</a></p>';
} catch (\Throwable $e) {
